...
Encore
    ...
    .addEntry( 'js/helpcenter-questions', './assets/admin-panel/js/pages/helpcenter-questions.js' )
    .addEntry( 'js/helpcenter-questions-edit', './assets/admin-panel/js/pages/helpcenter-questions-edit.js' )
    ...
    .addEntry( 'js/quick-links', './assets/admin-panel/js/pages/quick-links.js' )
    .addEntry( 'js/quick-links-edit', './assets/admin-panel/js/pages/quick-links-edit.js' )
    .addEntry( 'js/sliders', './assets/admin-panel/js/pages/sliders.js' )
    .addEntry( 'js/sliders-edit', './assets/admin-panel/js/pages/sliders-edit.js' )
