 ...
 */
final class Version20230820105529 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VVP_VideoPlatformSettings ADD coconut_input_url_type VARCHAR(32) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VVP_VideoPlatformSettings DROP coconut_input_url_type');
