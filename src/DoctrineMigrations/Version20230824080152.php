 ...
 */
final class Version20230824080152 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VVP_VideoPlatformSettings ADD create_user_signed_videos TINYINT(1) DEFAULT 0 NOT NULL, ADD disable_videos_for_non_authenticated TINYINT(1) DEFAULT 0 NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VVP_VideoPlatformSettings DROP create_user_signed_videos, DROP disable_videos_for_non_authenticated');
