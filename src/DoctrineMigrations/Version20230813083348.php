 ...
 */
final class Version20230813083348 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VVP_VideoPlatformSettings CHANGE `key` settings_key VARCHAR(32) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VVP_VideoPlatformSettings CHANGE settings_key `key` VARCHAR(32) NOT NULL');
