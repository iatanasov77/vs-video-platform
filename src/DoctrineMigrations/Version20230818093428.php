 ...
 */
final class Version20230818093428 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VVP_VideoPlatformSettings ADD coconut_system_user VARCHAR(32) NOT NULL, ADD coconut_system_password VARCHAR(32) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VVP_VideoPlatformSettings DROP coconut_system_user, DROP coconut_system_password');
