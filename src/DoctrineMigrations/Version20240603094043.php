 ...
 */
final class Version20240603094043 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE VVP_CoconutJobs (id INT AUTO_INCREMENT NOT NULL, video_id INT DEFAULT NULL, job_id VARCHAR(32) NOT NULL, job_data LONGTEXT DEFAULT NULL, status VARCHAR(32) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_45AE9E4729C1004E (video_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE VVP_CoconutSettings (id INT AUTO_INCREMENT NOT NULL, storage_id INT NOT NULL, title VARCHAR(64) NOT NULL, coconut_api_key VARCHAR(255) NOT NULL, coconut_output_formats LONGTEXT NOT NULL, coconut_system_user VARCHAR(32) NOT NULL, coconut_system_password VARCHAR(32) NOT NULL, coconut_input_url_type VARCHAR(32) NOT NULL, coconut_watermark TINYINT(1) DEFAULT 0 NOT NULL, INDEX IDX_A1C4C5875CC5DB90 (storage_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE VVP_VideoPlatformStorages (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(64) NOT NULL, storage_type ENUM(\'coconut\', \'local\' , \'s3\' , \'digitalocean\'), settings LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE VVP_Videos (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, published TINYINT(1) NOT NULL, slug VARCHAR(255) NOT NULL, name VARCHAR(64) NOT NULL, description VARCHAR(255) DEFAULT NULL, in_stock INT DEFAULT 0 NOT NULL, tags VARCHAR(255) DEFAULT \'\', created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, average_rating DOUBLE PRECISION DEFAULT \'0\' NOT NULL, UNIQUE INDEX UNIQ_49B70CBA989D9B62 (slug), INDEX IDX_49B70CBAA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
