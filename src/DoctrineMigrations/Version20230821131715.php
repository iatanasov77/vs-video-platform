 ...
 */
final class Version20230821131715 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VVP_VideoPlatformSettings ADD display_only_transcoded TINYINT(1) DEFAULT 0 NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VVP_VideoPlatformSettings DROP display_only_transcoded');
