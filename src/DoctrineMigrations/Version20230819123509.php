 ...
 */
final class Version20230819123509 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VVP_Videos_Files ADD storage_type ENUM(\'coconut\', \'local\' , \'s3\' , \'digitalocean\')');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VVP_Videos_Files DROP storage_type');
    }
}
