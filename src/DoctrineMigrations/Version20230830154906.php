 ...
 */
final class Version20230830154906 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VVP_Videos ADD tags VARCHAR(255) DEFAULT \'Full HD,18+\' NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VVP_Videos DROP tags');
