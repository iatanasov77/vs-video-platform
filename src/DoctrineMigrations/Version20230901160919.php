 ...
 */
final class Version20230901160919 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_597820C8389B783 ON VVP_VideoTags (tag)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_597820C8389B783 ON VVP_VideoTags');
