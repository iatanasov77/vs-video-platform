 ...
 */
final class Version20240606080316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE VVP_YoutubeChannels ADD project_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_E8EDA74166D1F9C ON VVP_YoutubeChannels (project_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_E8EDA74166D1F9C ON VVP_YoutubeChannels');
        $this->addSql('ALTER TABLE VVP_YoutubeChannels DROP project_id');
    }
}
