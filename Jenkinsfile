...
node ( label: 'php-host' ) {
    ...
    def HOST_PREFIX             = 'video-platform-'
    def APP_HOST                = 'video-platform.vankosoft.org'
    ...
    final GIT_URI               = 'github.com/iatanasov77/vs-video-platform.git'
    final GIT_REPO_URL          = "https://${GIT_URI}"
    def GIT_REPO_WITH_CRED;
    
    def MYSQL_CREDENTIALS_ID    = 'vankosoft-mysql';
    def MYSQL_DATABASE_PREFIX   = 'c0VideoPlatform_';
    def APP_MYSQL_USER;
    ...
    def FTP_CREDENTIALS_ID      = 'videoplatform-ftp';
    def APP_DIR                 = '/opt/VankosoftProjects/VideoPlatform';
    def APP_FTP_USER;
    def APP_FTP_PASSWORD;
    def APP_FTP_URL;
    
    def GOOGLE_MEASUREMENT_CREDENTIALS_ID   = 'videoplatform-google-measurement-id';
